...
public class Recurso {
  ...
  public static final Long medicoPts = 3l,
      enfermeiroPts = 3l,
      respiradorPts = 5l,
      tomografoPts = 12l,
      ambulanciaPts = 10l;

  @Builder.Default private Long medico = 0l;
  @Builder.Default private Long enfermeiro = 0l;
  @Builder.Default private Long respirador = 0l;
  @Builder.Default private Long tomografo = 0l;
  @Builder.Default private Long ambulancia = 0l;

  public Long pontos() {
    Long total = 0l;
    if (!(this.medico == null)) total += this.medico * Recurso.medicoPts;
    if (!(this.enfermeiro == null)) total += this.enfermeiro * Recurso.enfermeiroPts;
    if (!(this.respirador == null)) total += this.respirador * Recurso.respiradorPts;
    if (!(this.tomografo == null)) total += this.tomografo * Recurso.tomografoPts;
    if (!(this.ambulancia == null)) total += this.ambulancia * Recurso.ambulanciaPts;
    return total;
  }
  ...
  public void subtrai(Recurso recurso) throws RecursoExcedidoException {
    ...
    this.enfermeiro -= recurso.enfermeiro;
    if (this.medico < recurso.medico) throw new RecursoExcedidoException("Nr de medicos excedido.");
    this.medico -= recurso.medico;
